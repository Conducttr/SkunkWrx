	...
	<body>
		<div id="blog-wrapper" class="wrapper" >
			<div class="header" id="blog-header"> 
				<a id='back' title="Back button" href="#" onclick="back();return false;" ><span class="helper"></span><img src="<?php echo "styles/".$_SESSION['PROJECT_ID']; ?>/images/mail_back.png"></a>
			...
			<div id="content-area" class="blog-area"></div>
			<div id="send-message-area"></div>
			<table id="buttons">
				<tr>
					<td onclick="window.location='profile.php'" ><img src="<?php echo "styles/".$_SESSION['PROJECT_ID']; ?>/images/profile.png" style="height:30px;"><span>Profile</span></td>
					<?php if($api->get_badges_group() != 0) echo' <td onclick="window.location=\'badges.php\'" ><img src="styles/'.$_SESSION['PROJECT_ID'].'/images/badges.png" style="height:30px;"><span>Badges</span></td>'; ?>
					<td onclick="window.location='files.php'"><img src="<?php echo "styles/".$_SESSION['PROJECT_ID']; ?>/images/files.png" style="height:25px;"><span>Files</span></td>
				</tr>
			</table>
		</div>
