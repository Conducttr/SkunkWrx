...
<html lang="en">
	...
	<body>
		<div id="gosocial-wrapper" class="wrapper" >
			...
			<div id="content-area" class="gosocial-area"></div>
			<div id="send-message-area"></div>

			<table id="buttons">
				<tr>
					<td onclick="window.location='profile.php?b=f'" ><img src="<?php echo "styles/".$_SESSION['PROJECT_ID']; ?>/images/profile.png" style="height:30px;"><span>Profile</span></td>
					<?php if($api->get_badges_group() != 0) echo' <td onclick="window.location=\'badges.php?b=f\'" ><img src="styles/'.$_SESSION['PROJECT_ID'].'/images/badges.png" style="height:30px;"><span>Badges</span></td>'; ?>
					<td onclick="window.location='files.php?b=f'"><img src="<?php echo "styles/".$_SESSION['PROJECT_ID']; ?>/images/files.png" style="height:25px;"><span>Files</span></td>
				</tr>
			</table>
		</div>
