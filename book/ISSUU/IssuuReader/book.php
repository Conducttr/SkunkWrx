...
An Interactive Book hosted in ISSUU

-> This codes allows  to lock or unlock different pages in the book based triggers
...
<html>
    <head>
        ...
        <title>Interactive book using Conducttr</title>
    </head>
